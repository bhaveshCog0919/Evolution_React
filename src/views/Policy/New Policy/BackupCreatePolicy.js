...
class NewPolicy extends Component {
    ...
    getMarinBinder() {
        api.post('api/getMarinBinder').then(res => {
            console.log('getMarinBinder', res.data);
    ...
    conditionalFields(policyType) {
        ...
        if (policyType == 'MarineTrade' || policyType == 'MultiVessel') {
    ...
    selectType(value, type) {
        ...
        if (type === 'vesselClass') {
            ...
            if (value === '' || value === undefined || value === null) {
                ...
                this.setState({ VesselClassError: false, vesselClass: value.value, VesselType: '' });
                ...
                if (SelectedId == "Dinghy" || SelectedId == "Rowing Sculls") {
                    this.setState({
                        conditionalEngine: 0, mainEngine: '', mainEngineHp: '', mainEngineYear: '', noOfEngine: '', tarnsmissionMainEngine: '',
                    ...
                    this.setState({
                        conditionalEngine: 1, mainEngine: '', mainEngineHp: '', mainEngineYear: '', noOfEngine: '', tarnsmissionMainEngine: '',
                        ...
                        <Row>
                            ...
                            {(this.state.policyType == 'MarineTrade' || this.state.policyType == 'MultiVessel')
                                ? (<Col md="3">
                                    <div className="form-heading">
                                        <h3>
                                            {(this.state.policyType == 'MarineTrade')?'Marine Trade':'Multi Vessel'} Params
                                        </h3>
                                    </div>
                                    <Card>
                                        <CardBody>
