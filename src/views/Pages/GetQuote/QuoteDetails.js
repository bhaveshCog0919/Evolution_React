            ...
            api.post('api/getPolicyHolderDetails', data).then(res => {
                ...
                if (res.success) {
                    ...
                    this.setState({
                        ...
                        phone: res.data[0][0].CountryCode + ' ' + ((res.data[0][0].AreaCode == null) ? '' : res.data[0][0].AreaCode) + ' ' + CommonConfig.formatPhoneNumber(res.data[0][0].Phone),
            ...
            <Row>
                ...
                <Col md="12">
                    <div className="policy-warning">
                        <div style={{ textAlign: "center", width: "100%" }}><span style={{ marginRight: 15 }}>You will be able to make changes in your quote as desired after login. You will shortly receive two emails 1) Login Credentials    2) Quote Information. Thank you for your inquiry</span></div>
                    </div>
                </Col>
                ...
                <div className="container">
                    <Col style={{ marginTop: "20px" }}>
                        ...
                        <div className="input-box">
                            <Row>
                                <Col md="6">
                                    <Card>
                                        <CardBody style={{ backgroundColor: "#f9f7f7" }}>
                                            <div className="input-box">
                                                {/* <Row>
                                                    <Col md="12">
                                                        <div className="policy-box">
                                                            <p><b>{t("generateQuote:Binder")}</b></p>
                                                            <div className="pl-inner">
                                                                {this.state.binder}
                                                            </div>
                                                        </div>
                                            ...
                                            {(this.state.premiumType == 'Comprehensive') ? (
                                                <div>
                                                    ...
                                                    <hr style={{ height: 1, backgroundColor: '#000000', width: "100%", marginBottom: 7, marginTop: -12 }} />
                                                    {/* <div className="input-box">
                                                        <Row>
                                                            <Col md="2">
                                                            </Col>
                    ...
                    <div className="input-box">
                            ...
                            (<div className="input-box">
                                <Row>
                                    <Col md="12">
                                        ...
                                        <span>{t("generateQuote:I agree to the")} {this.state.assumptionCount == 0 ? 'Assumptions' : (<a onClick={() => this.openModal('Assumption')} style={{ textDecorationLine: 'underline', cursor: 'pointer' }}>{t("generateQuote:Assumptions")}</a>)} {t("generateQuote:as well as")} <a onClick={() => this.openModal('TermsAndCondition')} style={{ textDecorationLine: 'underline', cursor: 'pointer' }}>{t("generateQuote:Terms & Conditions")}</a></span>
                        ...
                        <div className="input-box">
                            <Row>
                                <Col md="12" style={{ textAlign: "center" }}>
                                    <BTN color="primary" onClick={() => this.Login()} style={{ marginRight: 10 }} >
                                        <i style={{ marginRight: 4 }} className="fa fa-user" />
                                        Login
                                    </BTN>
                                    {/* <BTN color="success" onClick={() => this.SaveQuatation()} disabled={this.state.ButtonGenerateDisable} >
                                        <i style={{ marginRight: 4 }} className="fa fa-check"></i>
...
export default withTranslation()(QuoteDetails);